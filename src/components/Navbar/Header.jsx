...
function Header() {
  ...
  // Add Dashboard for partners
  const navItems = userType === 'partner' 
  ...
  const handleItemClick = (item) => {
    ...
    if (item === 'Dashboard' && userType === 'partner') {
      navigate('/partner')
    }
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            {navItems.map((item) => (
              <div key={item} className="relative group">
                ...
                >
                  {item === 'Dashboard' && userType === 'partner' ? (
            ...
            {isAuthenticated ? (
              <div className="mt-4 space-y-2">
                ...
                <div className="px-4 space-y-2">
                  ...
                  {/* Dashboard option for partners in mobile */}
                  {userType === 'partner' && (
                    <button
