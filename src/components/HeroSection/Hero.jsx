...
function Hero() {
  ...
  const [searchForm, setSearchForm] = useState({
    tripType: 'one-way',
    origin: '',      // Changed from 'from' to 'origin'
    destination: '', // Changed from 'to' to 'destination'
    departureDate: '', // Changed from 'departDate' to 'departureDate'
    returnDate: '',
    passengers: 1,   // Changed to simple number instead of object
    cabinClass: 'economy', // Changed from 'class' to 'cabinClass'
    directFlightsOnly: false, // Changed from 'directFlights' to 'directFlightsOnly'
    flexibleDates: false
  })
